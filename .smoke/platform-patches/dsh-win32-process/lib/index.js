...
// LOCAL PATCH for dsh-vscode: CREATE_NO_WINDOW on the ordinary Job runner.
// windowsHide on the runner Node process only hides the runner console; the
// target created via CreateProcessW still got a visible one. Archive/branch
// slowness was later isolated to a dirty DSH_HOME (old sessions/checkpoints),
// not this flag — safe to keep the target silent.
