...
import { EdgeType, HttpMemoryProvider, HttpProviderOptions, Insight, JsonValue, MemoryBody, MemoryGraphSnapshot, MemoryListRequest, MemoryProviderAdapter, MemorySpaceAuthority, ProviderBodyStatus, ProviderMemorySpace, ProviderSearchResult, RememberRequest, SearchRequest } from "dsh-mnemon-source-memory-spaces/provider-sdk";
//#region src/driver.d.ts
declare class HindsightProvider extends HttpMemoryProvider implements MemoryProviderAdapter {
...
//#endregion
export { HindsightProvider, _default as default, definition, descriptor };