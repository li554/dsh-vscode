...
export async function fetchNativeImageState(timeoutMs = DEFAULT_NATIVE_STATE_TIMEOUT_MS) {
    try {
...
export async function setNativeImageEnabled(enabled, timeoutMs = DEFAULT_NATIVE_TOGGLE_TIMEOUT_MS) {
    try {
        ...
        if (envelope === null || typeof envelope !== 'object')
            return { ok: false, message: 'bad envelope' };
        if (envelope.ok === true)
