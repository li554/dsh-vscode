...
export declare const zh: {
    ...
    'field.apiStyle.anthropicMessages': string;
    'field.apiKey': string;
    ...
    'field.interceptImageSend': string;
    'field.interceptImageSend.hint': string;
    'probe.fetchModels': string;
    'probe.connectivity': string;
    'probe.running': string;
    'probe.hint': string;
    'probe.testHint': string;
    'probe.fetched': string;
    'probe.success': string;
    'probe.error': string;
    'preview.expand': string;
    'preview.close': string;
    'native.title': string;
    'native.loading': string;
    'native.enable': string;
    'native.disable': string;
    'native.busy': string;
    'native.enabled': string;
    'native.disabled': string;
    'native.unknownModel': string;
    'native.unsupported': string;
    'native.failed': string;
};
