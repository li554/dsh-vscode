 ...
 */
import { type Document, type ScalarTag, type YAMLMap, type YAMLSeq } from 'yaml';
/**
 ...
 */
export declare function writePatchAtomic(patchPath: string, text: string): Promise<void>;
/** YAML `!!js` expression tag: expressions stay literal until the Loader evaluates them. */
export declare const JS_EXPRESSION_TAG: ScalarTag;
 ...
 */
export declare function parsePatch(text: string, filename: string): PatchDocumentView;
/** The string id of a bare row, when it carries one. */
export declare function bareRowId(item: unknown): string | undefined;
/** The string name of a bare row, when it carries one. */
export declare function bareRowName(item: unknown): string | undefined;
/**
 ...
 */
export declare function bareRowEnabled(item: unknown): boolean;
/**
 ...
 */
export declare function findBareRow(root: YAMLSeq, id: string): {
    row: YAMLMap;
    index: number;
} | undefined;
/**
 ...
 */
export declare function claimedIdsOf(patchText: string): string[];
 ...
 */
export declare function insertRowsOf(patchText: string): InsertRow[];
/**
 ...
 */
export declare function findInsertRow(root: YAMLSeq, id: string): YAMLMap | undefined;
/**
 ...
 */
export declare function setRowEnabled(text: string, filename: string, id: string, name: string, enabled: boolean): string;
