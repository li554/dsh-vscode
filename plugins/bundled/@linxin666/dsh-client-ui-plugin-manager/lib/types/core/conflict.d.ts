 ...
 */
export declare function diffControls(before: readonly PluginControlItem[], after: readonly PluginControlItem[]): ControlChange[];
/**
 ...
 */
export declare function classifyChange(change: ControlChange): ControlChangeKind;
