...
export declare const DEFAULT_DOCTOR_POLICY: DoctorPolicy;
...
export type SupervisorRequest = {
    ...
    protocol: typeof DOCTOR_PROTOCOL_VERSION;
    type: 'action';
    action: 'provision' | 'exercise' | 'diagnose' | 'repair' | 'confirm' | 'rollback' | 'pause' | 'resume' | 'uninstall';
    profileId?: string;
    incidentId?: string;
};
...
export declare function isSupervisorRequest(value: unknown): value is SupervisorRequest;
