 ...
 */
import { isBranchesView, isGitError, isGraphView, isRepoStatus, } from "../core/types.js";
import { PollGuard } from "./poll-guard.js";
import { isGitAllowed } from "./access.js";
...
const MALFORMED_VIEW = { code: 'internal', message: 'malformed git response' };
 ...
 */
export function registerGitRoutes(ctx, service) {
