...
export declare const EMBEDDING_PROTOCOL_AUTO = "auto";
export declare const EMBEDDING_PROTOCOL_OLLAMA = "ollama";
export declare const EMBEDDING_PROTOCOL_OPENAI = "openai";
