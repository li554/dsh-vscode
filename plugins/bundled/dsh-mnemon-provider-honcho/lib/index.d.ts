...
declare class HonchoProvider extends HttpMemoryProvider implements MemoryProviderAdapter {
  readonly id: "honcho";
...
//#endregion
export { HonchoProvider, _default as default, definition, descriptor };