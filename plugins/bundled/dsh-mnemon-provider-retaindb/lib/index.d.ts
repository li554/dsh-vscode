...
declare class RetainDbProvider extends HttpMemoryProvider implements MemoryProviderAdapter {
...
//#endregion
export { RetainDbProvider, _default as default, definition, descriptor };