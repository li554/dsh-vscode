...
export declare function isDefaultSourceInstance(instanceKey: string, sourceTypeId: string): boolean;
...
export interface MemoryTopologyDefinition {
    id: string;
    strategyId: string;
    layers: Array<ResolvedMemoryLayerConfig & {
        id: string;
    }>;
}
...
import type { MemoryPersistenceStrategy, ResolvedMemoryPersistenceStrategy, MemoryProviderRuntimeStatus, MemoryBodyStats as MemorySpaceStats, MemoryBodyView as MemorySpaceView } from 'dsh-mnemon-source-memory-spaces/contracts';
...
export declare const MNEMON_ACTIVATION_CHANNEL = "/dsh-mnemon-activation";
...
export declare const MNEMON_REMOTE_CHANNEL = "/api";
export declare const MNEMON_REMOTE_NAMESPACE = "dshMnemon";
export declare const MNEMON_REMOTE_READ_ENDPOINT = "dshMnemon/read";
export declare const MNEMON_REMOTE_ACTIVATION_ENDPOINT = "dshMnemon/activation";
export declare const MNEMON_REMOTE_WRITE_ENDPOINT = "dshMnemon/write";
export declare const MNEMON_REMOTE_PACK_ENDPOINT = "dshMnemon/pack";
export declare const MNEMON_REMOTE_SETTINGS_ENDPOINT = "dshMnemon/settings";
export declare const MNEMON_REMOTE_VIEW_ENDPOINT = "dshMnemon/view";
export declare const MNEMON_REMOTE_VIEW_WRITE_ENDPOINT = "dshMnemon/viewWrite";
...
export declare function isWorkspaceStorageScope(scope: string | undefined): boolean;
...
export interface TaskAgentModelCatalog {
    effective?: {
        provider: string;
        model: string;
        source: 'fixed' | 'dsh-default' | 'active-agent';
    };
    defaultSelection?: {
        provider: string;
        model: string;
...
export declare const DEFAULT_EMBEDDING_ENDPOINT = "http://localhost:11434";
export declare const DEFAULT_EMBEDDING_MODEL = "nomic-embed-text";
export declare const DEFAULT_EMBEDDING_PROTOCOL = "auto";
export declare const MNEMON_EMBEDDING_PROTOCOLS: readonly ["auto", "ollama", "openai"];
