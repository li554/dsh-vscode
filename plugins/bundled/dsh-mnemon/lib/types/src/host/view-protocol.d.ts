...
export declare const MNEMON_VIEW_CHANNEL = "/dsh-mnemon-view";
export declare const MNEMON_VIEW_WRITE_CHANNEL = "/dsh-mnemon-view-settings";
export declare const MNEMON_VIEW_SETTINGS_NAMESPACE = "mnemon-view";
export interface MemoryPluginPreference {
    enabled: boolean;
