 ...
 */
import type { MemoryCapability, MemoryJsonValue, MemoryOperationScope, MemoryReceiptStatus, MemorySourceMode } from './index.ts';
export declare const COMPOSABLE_MEMORY_API_VERSION: "dsh-mnemon/v1";
...
export declare const DEFAULT_MEMORY_VIEW_BUDGET: Readonly<MemoryViewBudget>;
