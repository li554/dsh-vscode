import type { MemoryJsonValue, MemorySourceManagementInstance, MemorySourceManagementResult } from "../core/contracts/index.js";
...
export interface MnemonSourceManagementClient {
    ...
    readonly assistance?: {
        ...
        execute(operation: string, input: MemoryJsonValue, options: {
...
export type MemorySourcePageInstance = Omit<MemorySourceManagementInstance, 'capabilities'> & {
...
export interface MemorySourcePageProps {
    ...
    preferences?: {
        ...
        writable: boolean;
        replace(value: MemoryJsonValue): Promise<void>;
    };
}
