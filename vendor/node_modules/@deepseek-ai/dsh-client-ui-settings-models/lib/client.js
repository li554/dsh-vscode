window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		"modelCheckboxRow": "zGbnIq_modelCheckboxRow",
					...
					models.map((model, index) => (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsxs)("label", {
								...
								className: ModelsSection_module_css_default["modelCheckboxRow"],
		...
		*/
		...
		const en = {
			...
			modelImageInput: "Accept image input",
