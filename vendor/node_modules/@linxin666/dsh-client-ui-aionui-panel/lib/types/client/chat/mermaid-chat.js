...
import { DATA_MD_SCOPE, enhanceMermaidBlocks, mermaidTheme, rethemeMermaidBlocks, shellIsDark, watchShellTheme } from "../preview/mermaid.js";
 ...
 */
export function enhanceScopesFor(records) {
 ...
 */
export function isPanelOwnedPre(pre) {
